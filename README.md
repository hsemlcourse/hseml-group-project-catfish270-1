...
git clone <https://github.com/hsemlcourse/hseml-group-project-catfish270-1/blob/ср1>
cd <hseml-group-project-catfish270-1>
...
|--------|--------------------|----------|------------|
| Baseline | 0.8723               | 0.9216     | Логистическая регрессия |
| Ансамбль (Voting) | 0.8753               | 0.9224     | Лучшая комбинация моделей |
